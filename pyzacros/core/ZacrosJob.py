...
class ZacrosJob( scm.plams.SingleJob ):
    ...
    *   ``restart`` -- ZacrosJob object from which the calculation will be restarted
    ...
    def __init__(self, lattice, mechanism, cluster_expansion, species_list, initial_state=None, restart=None, **kwargs):
...
#            print (list_of_species)
        ...
        check_molar_fraction(self.settings, self.species_list.gas_species())
    ...
    def get_simulation_input(self):
        ...
        gasSpecies = self.species_list.gas_species()
        ...
        surfaceSpecies = self.species_list.surface_species()
        surfaceSpecies.extend( self.mechanism.species() )
