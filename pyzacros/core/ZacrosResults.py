...
#        print (surface_species)
        for i,sname in enumerate(surface_species_names):
            for sp in self.job.species_list.surface_species():
                if( sname == sp.symbol ):
...
#        print (surface_species)
    ...
    def plot_lattice_states(self, data, pause=-1, show=True, ax=None, close=False, time_perframe=0.5, file_name=None, block=False):
        """
    ...
    def plot_molecule_numbers(self, species_name, pause=-1, show=True, ax=None, close=False,
                                file_name=None, normalize_per_site=False, derivative=False, block=False):
        """
        ...
        *   ``derivative`` -- Plots the first derivative.
        ...
        COLORS = ['red', 'green', 'blue', 'magenta', 'navy', 'maroon','darkorange','gold','dodgerblue','lawngreen','sandybrown','salmon',
                  'dimgray','brown','sienna','peru','tan','olive', 'pink','indigo','cyan','tomato']
    ...
    def __plot_process_statistics(self, data, key, log_scale=False, pause=-1, show=True, ax=None, close=False, xmax=None, file_name=None, block = False):
        """
    ...
    def plot_process_statistics(self, data, key, log_scale=False, pause=-1, show=True, ax=None, close=False, file_name=None, block = False):
        """
